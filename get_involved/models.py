...
class Volunteer(models.Model):
    ...
    volunteer_text_dr = models.TextField(null=True, blank=True)
...
class Donate(models.Model):
    ...
    donate_text_support_dr = models.TextField(null=True, blank=True)
...
class CareerDetail(models.Model):
    ...
    career_desc_dr = models.CharField(max_length=300, default='', null=True, blank=True)
